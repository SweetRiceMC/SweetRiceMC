...
### Ⅰ.不文明行为
聊天室、游戏内发表不礼貌、歧视、厌恶言论，或干扰其他玩家。首次违规将被口头警告，重复违规者将被禁言或踢出游戏，并扣除一定数量的游戏货币。  
...
### Ⅱ.使用作弊/外挂程序
1. 在游戏中使用任何作弊程序或外挂软件，或使用任何其他非法手段获取优势。一经发现将被禁止登录，并扣除一定数量的游戏货币。
2. 发现漏洞时，你有义务向管理组反馈漏洞，管理组将视漏洞大小给予相应奖励。瞒报者被发现或被举报时，管理组有权对其进行永久禁止登录、删除游戏数据等。管理组有义务隐藏举报者信息，并在处理完毕后给予举报者一定奖励。

对于包括但不限于以上行为，管理组通常会采取以下处罚措施：
...
### Ⅲ.领地安全保护
1. 破坏他人建筑：对于在他人领地内恶意破坏建筑、放置炸药等物品者，首次违规将被管理组给予口头警告，重复违规者将被禁言或踢出游戏，并扣除一定数量的游戏货币。
2. 盗窃/抢夺他人财物：在游戏中盗用其他玩家成果，或窃取他人财产。首次违规将被口头警告，重复违规者将被禁言或踢出游戏，并扣除一定数量的游戏货币。
...
### Ⅳ.恶意攻击服务器
破坏服务器、攻击服务器等影响服务器正常运行的行为（举例：DDOS、CC攻击），或以不正当手法攻击其他玩家的行为（举例：语言攻击等破坏了公共聊天频道的洁净）。一经发现将被禁止登录，并扣除一定数量的游戏货币。  
...
***SweetRice管理团队，于 2023 年 5 月 30 日编辑。***
